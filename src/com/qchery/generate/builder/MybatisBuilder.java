...
public class MybatisBuilder implements FileBuilder {
    ...
    public String getContent(ObjectDescriptor descriptor) {
        Mapper mapper = new Mapper(String.format("%s.%sDao", descriptor.getPackageName(), descriptor.getClassName()));
        ResultMap resultMap = new ResultMap("FullResultMap", StringUtil.lowerCaseFisrt(descriptor.getClassName()));
