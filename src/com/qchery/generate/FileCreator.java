...
public class FileCreator {
    ...
    public static void createFile(FileBuilder fileBuilder, ObjectDescriptor descriptor) throws IOException {
    ...
    private static String getFileStorageDir(String packagePath) {
        ...
        String srcPath = System.getProperty("user.dir") + File.separatorChar + "src" + File.separatorChar;
        if (null == resDir) {
            return srcPath;
        }
